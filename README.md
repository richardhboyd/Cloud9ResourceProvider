...
1. Write the JSON schema describing your resource, `richard-cloud9-environment.json`
2. Implement your resource handlers in `richard_cloud9_environment/handlers.py`
